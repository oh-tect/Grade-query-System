                ...
                <div class="container">
                    ...
                    <div class="pure-menu custom-restricted-width">
                        ...
                        <ul class="pure-menu-list">
                            ...
                            <li class="pure-menu-item"><a href="${pageContext.request.contextPath}/main/add" class="pure-menu-link"><i class="fas fa-plus"></i>
                                &nbsp;&nbsp;&nbsp;&nbsp;添加</a>
                            </li>
                            <li class="pure-menu-heading">设置</li>
                            <li class="pure-menu-item"><a href="#"
                                                          class="pure-menu-link">&nbsp;&nbsp;&nbsp;&nbsp;News</a></li>
                            <li class="pure-menu-item"><a href="#" class="pure-menu-link"><i class="fas fa-wrench"></i>
                                &nbsp;&nbsp;&nbsp;&nbsp;设置</a>
                            </li>
                        </ul>
                    </div>
